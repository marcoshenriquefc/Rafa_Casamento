...
import { uploadGiftImage } from '../middlewares/uploadGiftImageMiddleware.js';

export const giftRoutes = Router();

giftRoutes.get('/', giftController.listAvailable);
giftRoutes.post('/', authenticate, authorize(USER_ROLES.ADMIN, USER_ROLES.NOIVOS), uploadGiftImage, validate(createGiftSchema), giftController.create);
